...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body id="auto-box">
		...
		<div class="page-content">
            <?php if (count($data['data']['single']) <= 0) {
                    echo '<h1 class="mb0">没有找到相关文章！</h1>';
                } else { ?>
                    <h1 class="mb0"> <?= $data['data']['single']['title']; ?> </h1>
                    <div class="meta">
                        <span>
                            <?php foreach ($data['data']['single']['label'] as $value) {?>
                                <a href="#"><?= $value; ?></a>,
                            <?php } ?>
                        </span>
                    </div>

                    <?= $data['data']['single']['text']; ?>
             <?php } ?>
			...
			<div id="fh5co-projects-feed" class="fh5co-projects-feed clearfix masonry">
                ...
                foreach ($data['data']['lists'] as $value)
                {
                    ...
                    <div class="fh5co-project masonry-brick">
                        <a href="single?id=<?= $value['id']; ?>">
                            <img src="<?= $value['img']; ?>" alt="无法显示">
                            <h2><?=$value['title']; ?></h2>
                        </a>
                    </div>
                    <?php
